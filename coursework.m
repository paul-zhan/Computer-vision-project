...
% total X2
X2 = cat(2, allhists, sysy);
imfeature = cat(2,X2,circularity_mat);
...
% function to calculate the acuracy/ missclassification/precision/recall
...
% function that apply the gaussian index and then rotate the image to do it
% in another angle.
...
% function that count the number of color in the color histogram 
...
% function for the gamma transform
